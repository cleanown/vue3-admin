<template>
	<div class="navbar" :class="{'navbar-isCollapse' : layoutDataP.isCollapse}">
		<div class="fcc">
			<el-icon size="24" class="navbar-icon hover-opacity" :class="{'navbar-icon-close': !layoutDataP.isCollapse}" @click="handleCollapseChaneg"><Expand /></el-icon>
		...
		<div class="navbar-right">
			...
			<el-dropdown trigger="click" @command="handleUserMenuClick">
				<div class="fcc hover-opacity">
					<el-avatar class="user-avatar" :size="30" :src="userInfo.avatar || logoImg" />
...
import OtherLink from "./OtherLink.vue"
